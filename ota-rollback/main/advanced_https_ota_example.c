...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "  Type: %d", running_partition->type);  // %d para o tipo enumerado
    ESP_LOGI(TAG, "  Subtype: %d", running_partition->subtype);  // %d para o subtipo enumerado
    ESP_LOGI(TAG, "  Address: %li", running_partition->address);  // %08x para hexadecimal
    ESP_LOGI(TAG, "  Size: %libytes", running_partition->size);  // %08x para hexadecimal
